...
export default function BuyerWalletPage() {
  ...
  return (
    <div className="min-h-screen">
      <BuyerHeader title="Ví" description="Quản lý tín chỉ carbon và số dư tiền của bạn" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-secondary/30">
                ...
                <p className="text-sm text-muted-foreground">
                  Lưu trữ tín chỉ carbon đã mua từ marketplace. Bạn có thể tiêu hủy tín chỉ để nhận chứng chỉ giảm phát
                  thải cho báo cáo CSR.
                </p>
              </div>
              <div className="p-4 rounded-xl bg-secondary/30">
                <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Dùng để thanh toán khi mua tín chỉ carbon. Nạp tiền vào ví để mua tín chỉ trên marketplace.
                </p>
              </div>
            </div>
          </CardContent>
