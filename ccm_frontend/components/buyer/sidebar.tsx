...
const menuItems = [
  { href: "/buyer/dashboard", label: "Tổng quan", icon: LayoutDashboard },
  { href: "/buyer/marketplace", label: "Sàn giao dịch", icon: ShoppingCart },
  { href: "/buyer/wallet", label: "Ví", icon: Wallet },
  { href: "/buyer/purchases", label: "Lịch sử mua", icon: History },
  { href: "/buyer/certificates", label: "Chứng chỉ", icon: Award },
]
