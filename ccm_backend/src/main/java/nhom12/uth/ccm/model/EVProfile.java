...
public class EVProfile {
    ...
    @OneToMany(
            mappedBy = "evProfile", // "evProfile" là tên trường EVProfile bên class CarbonSaving
    ...
    @OneToMany(
            mappedBy = "evProfile", // "evProfile" là tên trường EVProfile bên class CarbonCreditRequest
            cascade = CascadeType.ALL,
            orphanRemoval = true,
            fetch = FetchType.LAZY
    )
